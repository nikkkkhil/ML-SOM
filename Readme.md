<h1>ML-SOM<img src='https://3.bp.blogspot.com/-_6UDGEHzIrs/WSfiyjmoeRI/AAAAAAAABHw/3UQylcCBEhUfHNhf56WSHBBmQ6g_lXQhwCLcB/s320/ML-SOM_logo.png' align='right'></h1>

Self Organizing Maps
--------------------

ML-SOM is a minimalistic and Numpy based implementation of the Self Organizing Maps (SOM). SOM is a type of Artificial Neural Network able to convert complex, nonlinear statistical relationships between high-dimensional data items into simple geometric relationships on a low-dimensional display.
...
---------------------
 ...
 download ML-SOM to a directory of your choice and use the setup script:

    git clone https://github.com/nikkkkhil/ML-SOM.git
    python setup.py install

How to use it
---------------------

In order to use ML-SOM you need your data organized as a Numpy matrix where each row corresponds to an observation or as list of lists like the following:
...
```
 ...
 Then you can run ML-SOM just as follows:

```python
from ML-SOM import ML-SOM    
som = ML-SOM(6, 6, 4, sigma=0.3, learning_rate=0.5) # initialization of 6x6 SOM
som.train_random(data, 100) # trains the SOM with 100 iterations
```

ML-SOM implements two types of training. The random training (implemented by the method `train_random`), where the model is trained picking random samples from your data, and the batch training (implemented by the method `train_batch`), where the samples are picked in the order they are stored.
...
For an overview of all the features implemented in ML-SOM you can browse the following examples: https://github.com/nikkkkhil/ML-SOM/tree/master/examples
...
Note that if a lambda function is used to define the decay factor ML-SOM will not be pickable anymore.
...
| | |
:-------------------------:|:-------------------------:
Iris map ![](https://github.com/nikkkkhil/ML-SOM/raw/master/examples/resulting_images/som_iris.png)  | Class assignment ![](https://github.com/nikkkkhil/ML-SOM/raw/master/examples/resulting_images/som_iris_pies.png)
Handwritteng digits mapping ![](https://github.com/nikkkkhil/ML-SOM/raw/master/examples/resulting_images/som_digts.png)  |  Images mapping <img src="https://github.com/nikkkkhil/ML-SOM/raw/master/examples/resulting_images/som_digts_imgs.png" alt="handwritten digitts recognition" width=450>
Color quantization ![](https://github.com/nikkkkhil/ML-SOM/raw/master/examples/resulting_images/som_color_quantization.png)  |  Outliers detection ![](https://github.com/nikkkkhil/ML-SOM/raw/master/examples/resulting_images/som_outliers_detection_circle.png)
...
Compatibility notes
---------------------
ML-SOM has been tested under Python 3.6.2.

License
---------------------

ML-SOM by Giuseppe Vettigli is licensed under the Creative Commons Attribution 3.0 Unported License. To view a copy of this license, visit [http://creativecommons.org/licenses/by/3.0/](http://creativecommons.org/licenses/by/3.0/ "http://creativecommons.org/licenses/by/3.0/").
